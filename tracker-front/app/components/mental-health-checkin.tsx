    ...
    <div className="space-y-6">
      <div className="text-center lg:text-left">
        ...
        <p className="text-slate-400">
          Evening reflection and emotional wellness tracking
        </p>
      </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-3">
                ...
                <Badge
                  variant="outline"
                  className={`bg-red-500/20 border-red-500/30 ${getStressColor(
                    stress[0]
                  )}`}
                >
                  {stress[0]}/10
            ...
            <div>
              <div className="flex justify-between items-center mb-3">
                ...
                <Badge
                  variant="outline"
                  className={`bg-orange-500/20 border-orange-500/30 ${getStressColor(
                    anxiety[0]
                  )}`}
                >
                  {anxiety[0]}/10
          ...
          {journalPrompts.map((prompt) => (
            <div key={prompt.key} className="space-y-2">
              ...
              <Textarea
                ...
                value={
                  journalResponses[prompt.key as keyof typeof journalResponses]
                }
                onChange={(e) =>
                  updateJournalResponse(prompt.key, e.target.value)
                }
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-3 bg-slate-800/30 rounded-lg">
              ...
              <p className={`text-lg font-bold ${getStressColor(stress[0])}`}>
                {stress[0]}/10
              </p>
            </div>
            <div className="text-center p-3 bg-slate-800/30 rounded-lg">
            ...
            <div className="text-center p-3 bg-slate-800/30 rounded-lg">
              ...
              <p className="text-lg font-bold text-blue-300">
                {Object.values(journalResponses).filter((r) => r.trim()).length}
                /5
              </p>
            </div>
          </div>
